<?php 
###########
## Módulo para Cadastro de Bancos
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
          ...
          <tr>
            ...
            <input class="button" title="Limpa o conteúdo dos campos digitados" name="Reset" type="reset" id="Reset" value="Limpar Campos">
             ...
             <td align="right">
						 		<input class="button" title="Emite o relatório dos Bancos cadastrados" name="btnRelatorio" type="button" id="btnRelatorio" value="Emitir Relatório" style="width:100px" onclick="abreJanela('./relatorios/BancoRelatorioPDF.php?UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaId=<?php echo $empresaId ?>&EmpresaNome=<?php echo $empresaNome ?>')" />
						 </td>
	         </tr>
         </table>
...
<table width="100%" id="4" cellpadding="0" cellspacing="0" border="0" class="listView">
	...
	?>
      ...
      <td width="42">
	  	  <div align="center">
          <img src="image/grid_exclui.gif" alt="Excluir Registro" width="12" height="12" border="0" onClick="if(confirm('Confirma a exclusão do registro ?\nA exclusão de registros desta tabela não é recomendada.\nRecomendamos a utilização da caixa [Cadastro Ativo] caso desejar desativar um registro.')) {wdCarregarFormulario('ProcessaExclusaoGet.php?Id=<?php echo $dados[id] ?>&Modulo=bancos&Retorno=BancoCadastra','conteudo')}" style="cursor: pointer"></a>
