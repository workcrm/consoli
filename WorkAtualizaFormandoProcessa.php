<?php 
###########
## Módulo para Atualização da base de dados para o módulo online - formando individual
## Criado: 16/03/2011 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
...
//Apaga os boletos do formando especificado
$limpa_boletos = mysql_query("DELETE FROM WORK_boleto WHERE formando_id = $edtFormandoId");

//Apaga o formando da base
$limpa_formandos = mysql_query("DELETE FROM WORK_formandos WHERE id = $edtFormandoId");

//Estabelece a conexão com o banco de dados local do work
include './conexao/ConexaoMySQL.php';

echo "<img src='image/logo_consoli2_pq.jpg'/><br/><br/><b>Inciando a rotina de transferência dos dados do formando</b><br/>Processo iniciado em <b>" . date('d/m/Y', mktime()) . "</b> as <b>" . date("H:i:s", mktime()) . "</b><br/>";
...
$sql_formando = "SELECT id, evento_id, nome, cpf, senha FROM eventos_formando where id = $edtFormandoId";
...
//Recupera dos dados do evento
$sql_boleto = "SELECT * FROM boleto where formando_id = $edtFormandoId";  
