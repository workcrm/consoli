<?php 
###########
## Módulo para exibição da filtragem do relatório das contas - por evento, formando e curso
## Criado: 04/05/2011 - Maycon Edinger
## Alterado: 
## Alterações:
##  
###########
...
function busca_formandos()
{
	...
	if (Form.cmbEventoId.value != 0)
	{
		...
		wdCarregarFormulario('ContaReceberBuscaFormandoCurso.php?EventoId=' + eventoId,'recebe_formandos');
...
<br />
<span class="TituloModulo"> Filtragem: <font color="#990000">Por Evento e Curso</font><br />
</span>
			...
			<table class="tabDetailView" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="listViewPaginationTdS1" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px" colspan="21">
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								<td class="tabDetailViewDL" style="TEXT-ALIGN: left"><img src="image/bt_cadastro.gif" width="16" height="15" /> Selecione o Evento e o Curso desejado para filtragem das contas:</td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" width="490" class="tabDetailViewDF">
						...
						[ Selecione um evento ] <input type="hidden" name="cmbCursoId" id="cmbCursoId" value="0" />
						</div>
					</td>
				</tr>
				<tr>
