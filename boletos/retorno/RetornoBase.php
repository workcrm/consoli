...
abstract class RetornoBase {
  ...
  private $nomeArquivo = "retorno.ret";
	...
	*/
	public function RetornoBase($nomeArquivo=NULL, $aoProcessarLinhaFunctionName="") {
	...
	public function setNomeArquivo($nomeArquivo) { $this->arquivo = $nomeArquivo; }
  ...
  * @param int $numLn Número da linha a ser processada
	...
	* @see setAoProcessarLinha*/
	public function triggerAoProcessarLinha($numLn, $vlinha) {
