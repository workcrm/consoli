...
<html>
<head>
<title>Work Eventos - Pré-visualização do boleto</title>
<META http-equiv=Content-Type content=text/html charset=ISO-8859-1>
<meta name="Generator" content="Work Eventos" />
...
#instr_header {
	background: url('imagens/logo_boleto.jpg') no-repeat top left;
	padding-left: 160px;
	height: 85px;
}
...
<div id="container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="160" style="padding-top: 5px; padding-bottom: 8px">
        <img src="imagens/logo_boleto.jpg" />
      </td>
      <td>
        <b><span style="font-size: 18px; color: #990000"><?php echo $dadosboleto["identificacao"]; ?></span></b><br/>        
        <?php echo $dadosboleto["endereco"]; ?><br/>
		    <?php echo $dadosboleto["cidade_uf"]; ?><br/>
        <?php echo $dadosboleto["telefone"]; ?>
      </td>
    </tr>
  </table>
  
	<div id="" style="border: 1px solid; padding-left: 10px;">
<!--
 ...
 -->
		...
		<div id="instr_content">
			...
			<li>
				...
				<p class="notice">Por favor, configure as margens esquerda e direita
				para 17mm.</p>
			</li>
			<li>
	...
	<div id="boleto">
		<div class="cut" style="padding-top: 6px;">
...
do Sacado</b></div></td></tr></tbody></table>
		...
		<table class="line" cellspacing="0" cellpadding="0">
  		<tbody>
    		...
    		<tr class="campos">
    			...
    			<td class="valor_doc"><?php echo $dadosboleto["valor_boleto_formata"]?></td>
    		</tr>
      </tbody>
    </table>
		...
		<table class="line" cellspacing="0" cellpadding="0">
  		<tbody>
    		...
    		<tr class="campos">
    			...
    			<td class="valor_doc2"><?php echo $dadosboleto["valor_boleto_formata"]?></td>
    		</tr>
  		</tbody>
		</table>
		...
		<tr><td class="last_line" rowspan="6">
          ...
          <?php
            ...
            //Verifica se deve imprimir a mensagem de reajuste
            if ($dadosboleto['imprime_reajuste'] == 1)
            {
            
              echo "<br/>
                    <p style='font-size: 18px'><b><u>ATENÇÃO:</u> BOLETO REAJUSTADO ATÉ: " . $dadosboleto['data_vencimento'] . "</b></p>";  
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
     ...
     <span style="font-size: 8px; color: #990000">Boleto gerado automaticamente. Work Eventos - www.worklabs.com.br</span>
	</div>
</div>
</body>
</html>
