<?php 
###########
## Módulo para exibição da filtragem do relatório dos boletos - por data
...
<br />
<span class="TituloModulo"> Filtragem: <font color="#990000">Boletos por data de vencimento</font><br />
</span>
          ...
          <td width="100" class="tabDetailViewDF">
		    ...
		    <tr>
  				...
  				<td colspan="3" class="tabDetailViewDF">
			    	  ...
			    	  <tr>
			    	  	<td width="110">
			    	  		<input type="radio" name="edtSituacao" value="3" checked="checked" /> Todos
								</td>
								<td width="110">
			    	  		<input type="radio" name="edtSituacao" value="0" /> Em Aberto
								</td>
			    	  	<td width="110">
			    	  		<input type="radio" name="edtSituacao" value="1" /> Recebidos
								</td>
			    	  	<td>
