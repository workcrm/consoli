<?php 
###########
## Módulo para alteraçao de Categorias de Serviço
...
<form name="frmCategoriaAltera" action="sistema.php?ModuloNome=CategoriaServicoAltera" method="post" onsubmit="return wdSubmitCategoriaAltera()">
  ...
  <tr>
    <td class="text" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
			  <tr>
			    <td width="440"><img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Alteração de Centro de Custo de Serviço </span></td>
			  </tr>
			  <tr>
			    <td colspan="5">
      ...
      <table id="2" width="100%" align="left" border="0" cellspacing="0" cellpadding="0">
		...
		//Monta o sql
    $sql = "SELECT * FROM categoria_servico WHERE id = $CategoriaId";
		//Executa a query
    ...
    $campos = mysql_fetch_array($resultado);
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">        
          <tr>
            ...
            <td align="right">
							 <input class="button" title="Retorna ao formulário de cadastro" name="btnVoltar" type="button" id="btnVoltar" value="Voltar" style="width:70px" onclick="window.location='sistema.php?ModuloNome=CategoriaServicoCadastra';" />						 
						</td>
	       	</tr>
         </table>
