<?php 
###########
## Módulo para Cadastro de Suubgrupos de Contas
## Criado: 10/07/2007 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
...
function wdSubmitGrupo() {
   ...
   if (Form.edtNome.value.length == 0) {
      alert("É necessário informar a descrição da Conta-caixa !");
      Form.edtNome.focus();
      return false;
   }
...
<form name="Grupo" action="sistema.php?ModuloNome=SubgrupoContaCadastra" method="post" onSubmit="return wdSubmitGrupo()">
...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="text">
  <tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	  <tr>
	    <td width="440">
				<img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Cadastro de Conta-Caixa</span>
			</td>
	  </tr>
	  <tr>
	    <td colspan="5">
        ...
        <tr>
          ...
          <?php
            ...
            if($_POST["Submit"]) {
    	    	...
    	    	$sql = mysql_query("INSERT INTO subgrupo_conta (
																empresa_id, 
																nome,
																tipo,
																ativo
        		...
        		echo "<div id='99'><table width='100%' border='0' align='left' cellpadding='0' cellspacing='0' class='text'><tr><td height='22' width='20' valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; padding-top: 1px; border-right: 0px'><img src='./image/bt_informacao.gif' border='0' /></td><td valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; border-left: 0px'><strong>Conta-Caixa cadastrada com sucesso !</strong></td></tr><tr><td>&nbsp</td></tr></table></td></tr><tr><td></div><script language='javascript'>setTimeout('oculta(99)', 2500)</script>";
         		}
        ?>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
          <tr>
	         <td style="PADDING-BOTTOM: 2px">
	        	 <input name="Submit" type="submit" class="button" title="Salva o registro atual" value="Salvar Conta-caixa" >
             <input class="button" title="Limpa o conteúdo dos campos digitados" name="Reset" type="reset" id="Reset" value="Limpar Campos">
           </td>
           <td align="right">
						 		<input class="button" title="Emite o relatório das Conta-caixa cadastradas" name="btnRelatorio" type="button" id="btnRelatorio" value="Emitir Relatório" style="width:100px" onclick="abreJanela('./relatorios/SubgrupoContaRelatorioPDF.php?UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaId=<?php echo $empresaId ?>&EmpresaNome=<?php echo $empresaNome ?>')" />
			     </td>
	       </tr>
         </table>
         ...
         <table class="tabDetailView" cellspacing="0" cellpadding="0" width="100%" border="0">
           <tr>
             <td class="listViewPaginationTdS1" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px" colspan="20">
               <table cellspacing="0" cellpadding="0" width="100%" border="0">
                 <tr>
                   <td class="tabDetailViewDL" style="TEXT-ALIGN: left"><img src="image/bt_cadastro.gif" width="16" height="15"> Informe os dados da Conta-caixa e clique em [Salvar Conta-caixa] </td>
			     			 </tr>
		       		 </table>             
				 		 </td>
	       	 </tr>
             ...
             <td width="85%" colspan="3" class="tabDetailViewDF">
                 ...
                 <tr valign="middle">
                   <td width="130" height="20">
                     <input name="edtTipo" type="radio" value="1" checked>&nbsp;Entrada (Crédito)
                   </td>
                   <td height="20">
                     <input name="edtTipo" type="radio" value="2">&nbsp;Saída (Débito)
                   </td>                   
                 </tr>
               </table>	
             </td>
...
<table width="100%" id="4" cellpadding="0" cellspacing="0" border="0" class="listView">
	  <tr>
	    <td colspan="15" align="right">
	      <table border="0" cellpadding="0" cellspacing="0" width="100%">
	        <tr>
	          <td colspan="2" nowrap align="left"  class="listViewPaginationTdS1"><span class="pageNumbers">Contas-caixa Cadastradas</span></td>
	        </tr>
	      </table>
	    </td>
	  </tr>
	...
	<?php
	  ...
	  //Cria a SQL
	  $consulta = "SELECT * FROM subgrupo_conta WHERE empresa_id = $empresaId ORDER BY tipo, nome";
		//Executa a query
      ...
      //Efetua o switch para exibir a imagem para quando o cadastro estiver ativo
  	  ...
  	  switch ($dados[tipo]) {
       	case 1: $tipo_figura = "Entrada";	break;
			  case 2: $tipo_figura = "Saída";	break;       	
			}
	...
	?>
	  ...
	  <tr height="16">
        <td width="42">
		  	  <div align="center">
            <img src="image/grid_exclui.gif" alt="Excluir Registro" width="12" height="12" border="0" onclick="if(confirm('Confirma a exclusão do registro ?\nA exclusão de registros desta tabela não é recomendada.\nRecomendamos a utilização da caixa [Cadastro Ativo] caso desejar desativar um registro.')) {wdCarregarFormulario('ProcessaExclusaoGet.php?Id=<?php echo $dados[id] ?>&Modulo=subgrupo_conta&Retorno=SubgrupoContaCadastra','conteudo')}" style="cursor: pointer"></a>
	    ...
	    <td valign="middle" bgcolor="#fdfdfd" class="currentTabList">
			...
			<td valign="middle" nowrap="nowrap" bgcolor="#fdfdfd" class="oddListRowS1" onclick="wdCarregarFormulario('SubgrupoContaAltera.php?Id=<?php echo $dados[id] ?>&headers=1','conteudo')">
