<?php 
###########
## Módulo para exibição da filtragem do relatório de pedido - por evento
...
//Efetua o lookup na tabela de fornecedor
//Monta o SQL de pesquisa
...
<br />
<span class="TituloModulo"> Filtragem: <font color="#990000">Pedidos do Foto e Vídeo por Evento e Fornecedor</font><br />
</span>
        ...
        <tr>
          <td class="listViewPaginationTdS1" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px" colspan="21">
            <table cellspacing="0" cellpadding="0" width="100%" border="0">
              <tr>
                <td class="tabDetailViewDL" style="TEXT-ALIGN: left"><img src="image/bt_cadastro.gif" width="16" height="15" /> Selecione o Evento e o Fornecedor desejado para filtragem:</td>
              </tr>
            </table>
          </td>
        </tr>
