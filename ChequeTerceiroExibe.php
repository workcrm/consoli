<?php 
###########
## Módulo para Exibição dos dados do cheque de terceiro
...
switch ($dados["status"]) 
{
	...
	case 3: 
		...
		switch ($dados["disposicao"]) 
		{
			...
			//Se for 2
			case 2: $desc_status .= " - Em Negociação"; break;	
			//Se for 3
			...
			//Se for 7 
			case 7: $desc_status .= " - Não Pode SPC"; break;
			//Se for 8 
			case 8: $desc_status .= " - SPC Pago"; break;
			//Se for 9 
			case 9: $desc_status .= " - Devolvido ao Titular"; break;
			//Se for 10
			case 10: $desc_status .= " - Cobrança Judicial"; break;
	...
	<tr>
		...
		<td style="PADDING-BOTTOM: 2px">
			<?php
				...
				echo "<form id='exclui' name='exclui' action='ProcessaExclusao.php' method='post'><input class=button title='Exclui este Cheque [Alt+X]' accessKey='X' onClick='return confirm(\"Confirma a exclusão deste Cheque ?\")' type='submit' value='Excluir' name='Delete'><input name='Id' type='hidden' value=$dados[id] /><input name='Modulo' type='hidden' value='cheques' /></form>";
...
<b>Observações: </b><br/>" . nl2br($campos[observacoes]) . "<br/> 
"; 
