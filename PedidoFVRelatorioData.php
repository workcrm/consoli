<?php 
###########
## Módulo para exibição da filtragem do relatório dos pedidos do FV - Por data
...
<br />
<span class="TituloModulo"> Filtragem: <font color="#990000">Pedidos do Foto e Vídeo por data de emissão</font><br />
</span>
