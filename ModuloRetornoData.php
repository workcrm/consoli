<?php 
###########
## Módulo para relatório dos retornos por data
...
<table width='100%' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td style="padding-bottom: 4px">
  		...
  		<input class="button" title="Emite o relatório dos retornos por data" name="btnRelatorio" type="button" id="btnRelatorio" value="Emitir Relatório" style="width:100px" onclick="wdCarregarRelatorio()" />	   	   		   		
 		</td>   
  </tr>
  <tr>
    <td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
               <tr valign="middle">
                 ...
                 <td width="190" height="20">
                   <input name="edtTipoConsulta" type="radio" value="2" />&nbsp;&nbsp;Não Processado - Juros
                 </td>
                 <td height="20">
                   <input name="edtTipoConsulta" type="radio" value="3" />&nbsp;&nbsp;Não Encontrados
                 </td>
              </tr>
            </table>
      	  </td>
