...

{
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">	
      ...
      <td>
        ...
        <td style="border-left: 1px solid; border-bottom: 1px solid; padding-right: 8px" align="right">
          <b><?php echo number_format($total_geral_produtos, 2, ",", ".") ?></b>
        </td>
      </tr>
			<tr>
        ...
        <td width="200" class="listViewThS1" height="20" background="image/fundo_consulta.gif" style="padding-left: 10px;">
					<?php
						...
						$diferenca_total = $total_geral_produtos - $geral_contrato;
      ...
      <tr>
        ...
        <td style="padding-right: 5px;" align="right">
          <span style="font-size: 12px">
          	<b><?php echo $dados_fechamento[total_colacao] ?></b>
        	</span>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="padding-right: 5px;" align="right">
          <span style="font-size: 12px">
          	<b><?php echo $dados_fechamento[total_baile] ?></b>
        	</span>
        </td>
      </tr>
    </table>
