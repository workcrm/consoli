<?php
###########
## Módulo para Atualização dos dados de sacado do boleto
## Criado: 05/01/2012 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
	...
	<tr>
		<td valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td width="750">
						<img src="image/lat_cadastro.gif"/>&nbsp;<span class="TituloModulo">Atualização de Sacado do Boleto</span>
					</td>
				</tr>
				<tr>
					<td colspan="5">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td style="padding-top: 10px;">
			<input class="button" value="Consultar Boleto" name="btnConsultaBoleto" type="button" id="btnConsultaBoleto" onclick="if (document.getElementById('cmbEventoId').value == 0){alert('É necessário selecionar um evento !')} else {wdCarregarFormulario('BoletoAlteraSacadoPesquisa.php?Boleto=' + document.getElementById('cmbEventoId').value,'consulta_boleto')}" />
		</td>
	</tr>
	<tr>
		<td>
			<br/>
			<div id='consulta_boleto'></div>
		</td>
	</tr>
</table>