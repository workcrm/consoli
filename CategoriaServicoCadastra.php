<?php 
###########
## Módulo para Cadastro de Categorias de Servicos
## Criado: 21/11/2007 - Maycon Edinger
## Alterado: 03/09/2008 - Maycon Edinger
## Alterações: 
## 03/09/2008 - Alterado o nome para Centro de Custo de Serviços
###########
...
function wdSubmitCategoria() {
   ...
   if (Form.edtNome.value.length == 0) {
      alert("É necessário informar a descrição do Centro de Custo de Serviço !");
      Form.edtNome.focus();
      return false;
   }   
...
<form name="Categoria" action="sistema.php?ModuloNome=CategoriaServicoCadastra" method="post" onSubmit="return wdSubmitCategoria()">
...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="text">
  <tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	  <tr>
	    <td width="440">
				<img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Cadastro de Centro de Custo de Serviços</span>
			</td>
	  </tr>
	  <tr>
	    <td colspan="5">
        ...
        <tr>
          ...
          <?php
            ...
            if($_POST["Submit"]) {
    	    	...
    	    	$sql = mysql_query("INSERT INTO categoria_servico (
																empresa_id, 
																nome, 
																ativo
																) values (				
        ...
        <TABLE cellSpacing='0' cellPadding="0" width="100%" border="0">
          <tr>
            ...
            <INPUT class="button" title="Limpa o conteúdo dos campos digitados" name="Reset" type="reset" id="Reset" value="Limpar Campos">
             ...
             <td align="right">
						 		<input class="button" title="Emite o relatório dos Centros de Custo de Serviços cadastrados" name="btnRelatorio" type="button" id="btnRelatorio" value="Emitir Relatório" style="width:100px" onclick="abreJanela('./relatorios/CategoriaServicoRelatorioPDF.php?UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaId=<?php echo $empresaId ?>&EmpresaNome=<?php echo $empresaNome ?>')" />
			    	</td>
	       	</tr>
         </table>
         ...
         <table class="tabDetailView" cellspacing="0" cellpadding="0" width="100%" border="0">
           <tr>
             <td class="listViewPaginationTdS1" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px" colspan="20">
               <table cellspacing="0" cellpadding="0" width="100%" border="0">
                 <tr>
                   <td class="tabDetailViewDL" style="TEXT-ALIGN: left"><img src="image/bt_cadastro.gif" width="16" height="15"> Informe os dados do Centro de Custo de Serviço e clique em [Salvar Centro de Custo] </td>
			     			 </tr>
		       		 </table>             
				 		 </td>
	       	 </tr>
...
<table width="100%" id="4" cellpadding="0" cellspacing="0" border="0" class="listView">
	  <tr>
	    <td colspan="15" align="right">
	      <table border="0" cellpadding="0" cellspacing="0" width="100%">
	        <tr>
	          <td colspan="2" nowrap align="left"  class="listViewPaginationTdS1"><span class="pageNumbers">Centro de Custos de Serviço Cadastrados</span></td>
	        </tr>
	      </table>
	    </td>
	  </tr>
	...
	<?php
	  ...
	  //Cria a SQL
	  $consulta = "SELECT * FROM categoria_servico WHERE empresa_id = $empresaId ORDER BY nome";
		//Executa a query
	...
	?>
	  ...
	  <tr height="16">
        <td width="42">
		  	  <div align="center">
            <img src="image/grid_exclui.gif" alt="Excluir Registro" width="12" height="12" border="0" onclick="if(confirm('Confirma a exclusão do registro ?\nA exclusão de registros desta tabela não é recomendada.\nRecomendamos a utilização da caixa [Cadastro Ativo] caso desejar desativar um registro.')) {wdCarregarFormulario('ProcessaExclusaoGet.php?Id=<?php echo $dados[id] ?>&Modulo=categoria_servico&Retorno=CategoriaServicoCadastra','conteudo')}" style="cursor: pointer"></a>
												          
            <img src="image/grid_edita.gif" alt="Editar Registro" width="12" height="12" border="0" onclick="wdCarregarFormulario('CategoriaServicoAltera.php?Id=<?php echo $dados[id] ?>&headers=1','conteudo')" style="cursor: pointer">          
          </div>
        </td>
	    <td valign="middle" nowrap="nowrap" bgcolor="#fdfdfd" class="oddListRowS1" onclick="wdCarregarFormulario('CategoriaServicoAltera.php?Id=<?php echo $dados[id] ?>&headers=1','conteudo')">
