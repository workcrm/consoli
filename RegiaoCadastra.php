<?php 
###########
## Módulo para Cadastro de Regioes
## Criado: 30/11/2011 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
...
function wdSubmitRegiao() 
{
	...
	if (Form.edtNome.value.length == 0) 
	{
		...
		alert("É necessário informar a descrição da Região !");
		Form.edtNome.focus();
		return false;
...
<form name="cadastro" action="sistema.php?ModuloNome=RegiaoCadastra" method="post" onsubmit="return wdSubmitRegiao()">
				...
				<tr>
					<td class="text" valign="top">
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width='440'>
									<img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Cadastro de Regiões</span>
								</td>
							</tr>
							<tr>
								<td>
									...
									<?php
										...
										if($_POST['Submit']) 
										{
											...
											echo "<div id='99'>
													<table width='100%' border='0' align='left' cellpadding='0' cellspacing='0' class='text'>
														<tr>
															...
															<td valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; border-left: 0px'>
																<strong>Categoria de Conta cadastrada com sucesso !</strong>
															</td>
														</tr>
														<tr>
															<td>&nbsp</td>
												...
												<script language='javascript'>setTimeout('oculta(99)', 2500)</script>";
										...
										<tr>
											<td class='listViewPaginationTdS1' style='PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px' colSpan='20'>
												<table cellSpacing=0 cellPadding=0 width="100%" border=0>
													<tr>
														<td class='tabDetailViewDL' style='TEXT-ALIGN: left'><img src="image/bt_cadastro.gif" width="16" height="15"> Informe os dados da Região e clique em [Salvar Região] </TD>
													</tr>
												</table>             
											</td>
										</tr>
		...
		<td>
			...
			<table width="750" id="4" cellpadding="0" cellspacing="0" border="0" class="listView">
				<tr>
					<td colspan="3" align="right">
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td colspan="2" nowrap align="left"  class="listViewPaginationTdS1"><span class='pageNumbers'>Regiões Cadastradas</span></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<?php
					...
					//Cria a SQL
					$consulta = "SELECT * FROM regioes WHERE empresa_id = $empresaId ORDER BY nome";
