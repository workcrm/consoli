<?php
###########
## Módulo de relatório de Ex-funcionários
...
$sql = mysql_query("SELECT
										...
										WHERE col.empresa_id = $empresaId AND col.tipo = 3
										ORDER BY col.nome");
...
function Header()
{
  ...
  $this->Cell(0,6,"Relação de Ex-Funcionários");
  $this->SetFont("Arial","",9);
...
$pdf->SetTitle("Relação de Ex-Funcionarios");
...
$pdf->Cell(0,6, "Total de Ex-Funcionários: " . $registros,"T");
