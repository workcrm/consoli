<?php
###########
## Módulo de relatório geral de Tipos de Movimentacao
## Criado: 10/12/2011 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
...
$sql = mysql_query("SELECT * FROM tipos_movimentacao WHERE empresa_id = '$empresaId' ORDER BY nome");
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,6,'Relação de Contas-caixa');
		$this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Tipos de Movimentação');
...
$pdf->Cell(0,6, 'Descrição do Tipo de Movimentação',1,0,'L',1);
$pdf->SetX(170);
$pdf->Cell(0,6, 'Ativo');
