<?php
###########
## Módulo de relatório geral de servicos do evento
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,6,'Relação Geral de Serviços');
		$this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação Geral de Serviços');
...
$pdf->SetX(27);
$pdf->Cell(140,6, 'Descrição do Serviço');
$pdf->Cell(10,6, 'Un');
