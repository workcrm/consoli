...
$pdf->SetFont('Arial', 'I', 9);
$pdf->SetX(35);
$pdf->Cell(0,4, $dados_evento['contato7'],0,0,'L');
$pdf->SetX(95);
$pdf->Cell(0,4, $dados_evento['contato_obs7'],0,0,'L');
$pdf->SetX(172);
$pdf->Cell(0,4, $dados_evento['contato_fone7'],0,0,'L');
$pdf->ln();
$pdf->SetFont('Arial', 'I', 9);
$pdf->SetX(35);
$pdf->Cell(0,4, $dados_evento['contato8'],0,0,'L');
$pdf->SetX(95);
$pdf->Cell(0,4, $dados_evento['contato_obs8'],0,0,'L');
$pdf->SetX(172);
$pdf->Cell(0,4, $dados_evento['contato_fone8'],0,0,'L');
$pdf->ln();
$pdf->SetFont('Arial', 'I', 9);
$pdf->SetX(35);
$pdf->Cell(0,4, $dados_evento['contato9'],0,0,'L');
$pdf->SetX(95);
$pdf->Cell(0,4, $dados_evento['contato_obs9'],0,0,'L');
$pdf->SetX(172);
$pdf->Cell(0,4, $dados_evento['contato_fone9'],0,0,'L');
$pdf->ln();
$pdf->SetFont('Arial', 'I', 9);
$pdf->SetX(35);
$pdf->Cell(0,4, $dados_evento['contato10'],0,0,'L');
$pdf->SetX(95);
$pdf->Cell(0,4, $dados_evento['contato_obs10'],0,0,'L');
$pdf->SetX(172);
$pdf->Cell(0,4, $dados_evento['contato_fone10'],0,0,'L');
$pdf->ln();
$pdf->SetFont('Arial', 'I', 9);
$pdf->SetX(35);
$pdf->Cell(0,4, $dados_evento['contato11'],0,0,'L');
$pdf->SetX(95);
$pdf->Cell(0,4, $dados_evento['contato_obs11'],0,0,'L');
$pdf->SetX(172);
$pdf->Cell(0,4, $dados_evento['contato_fone11'],0,0,'L');
$pdf->ln();
$pdf->SetFont('Arial', 'I', 9);
$pdf->SetX(35);
$pdf->Cell(0,4, $dados_evento['contato12'],0,0,'L');
$pdf->SetX(95);
$pdf->Cell(0,4, $dados_evento['contato_obs12'],0,0,'L');
$pdf->SetX(172);
$pdf->Cell(0,4, $dados_evento['contato_fone12'],0,0,'L');
	...
	
	{
		...
		
		{
			...
			while ($dados_categoria = mysql_fetch_array($sql_categoria))
			{
				...
				$valor_servicos = $valor_servicos + $valor_categoria;
			...
			$pdf->ln(8);
			$pdf->SetFont('Arial','BI',11);
			$pdf->Cell(0,6, 'Total dos Serviços do Evento: R$ ' . number_format($valor_servicos, 2, ',', '.'),'1');
			$pdf->ln(4);
