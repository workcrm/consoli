<?php
###########
## Módulo de relatório geral de subgrupos de conta
...
$sql = mysql_query("SELECT * FROM subgrupo_conta WHERE empresa_id = '$empresaId' ORDER BY nome");
...
$pdf->SetTitle('Relação de Contas-caixa');
...
$pdf->Cell(0,6, 'Descrição da Conta-caixa',1,0,'L',1);
$pdf->SetX(170);
$pdf->Cell(0,6, 'Ativo');
