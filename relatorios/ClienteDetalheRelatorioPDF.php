<?php
###########
## Módulo para montagem do relatório de Detalhamento do Cliente em PDF
...
/**
* @package workeventos
* @abstract Módulo para montagem do relatório de Detalhamento do Cliente em PDF
* @author Maycon Edinger - edinger@bol.com.br
* @copyright 2007 - Maycon Edinger
*/

//http://localhost/consoli/relatorios/ClienteDetalheRelatorioPDF.php?ClienteId=1&UsuarioNome=Maycon%20Edinger&EmpresaNome=Nome%20da%20empresa
...
{    
  ...
  $this->Cell(0,6,'Detalhamento do Cliente');
  $this->SetFont('Arial','',9);
