<?php
###########
## Módulo de relatório geral de cursos
...
$sql = mysql_query("SELECT * FROM cursos WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Cursos');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Cursos');
...
$pdf->Cell(0,6, 'Descrição do Curso',1,0,'L',1);
$pdf->SetX(180);
$pdf->Cell(0,6, 'Ativo');
