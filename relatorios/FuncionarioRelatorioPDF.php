<?php
###########
## Módulo de relatório de funcionários
...
function Header()
{
  ...
  $this->Cell(0,6,"Relação de Funcionários");
  $this->SetFont("Arial","",9);
...
$pdf->SetTitle("Relação de Funcionarios");
...
$pdf->Cell(0,6, "Total de Funcionários: " . $registros,"T");
