<?php
###########
## Módulo de relatório geral de cidades
## Criado: 19/05/2007 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
/**
* @package workeventos
* @abstract Módulo de Relatório geral de cidades
...
$sql = mysql_query("SELECT * FROM cidades WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Cidades');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Cidades');
...
$pdf->Cell(0,6, 'Descrição da Cidade',1,0,'L',1);
$pdf->SetX(160);
$pdf->Cell(0,6, 'Uf');
$pdf->SetX(180);
$pdf->Cell(0,6, 'Ativo');
