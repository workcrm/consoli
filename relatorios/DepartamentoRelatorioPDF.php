<?php
###########
## Módulo de relatório geral de departamentos
...
$sql = mysql_query("SELECT * FROM departamentos WHERE empresa_id = '$empresaId' ORDER BY nome");
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,6,'Relação de Departamentos');
		$this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Departamentos');
...
$pdf->Cell(0,6, 'Descrição do Departamento',1,0,'L',1);
$pdf->SetX(180);
$pdf->Cell(0,6, 'Ativo');
