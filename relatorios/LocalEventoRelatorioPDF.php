<?php
###########
## Módulo de relatório geral de locais do evento
...
/**
* @package workeventos
* @abstract Módulo de Relatório geral de locais do evento
...
$sql = mysql_query("SELECT * FROM local_evento WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Tipos de Local de Evento');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Tipos de Local do Evento');
...
$pdf->Cell(0,6, 'Descrição do Tipo de Local',1,0,'L',1);
$pdf->SetX(170);
$pdf->Cell(0,6, 'Ativo');
