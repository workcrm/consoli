<?php
###########
## Módulo de relatório geral de grupos de conta
...
$sql = mysql_query("SELECT * FROM grupo_conta WHERE empresa_id = '$empresaId' ORDER BY nome");
...
class PDF extends FPDF
{
  ...
  function Header()
  {
    ...
    $this->Cell(0,6,'Relação de Centro de Custo de Contas');
    $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Centro de Custo de Contas');
