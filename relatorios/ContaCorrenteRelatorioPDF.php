<?php
###########
## Módulo de relatório geral de conta corrente
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Conta Corrente');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Conta Corrente');
...
$pdf->Cell(0,6, 'Código',1,0,'L',1);
$pdf->SetX(24);
$pdf->Cell(0,6, 'Descrição da Conta Corrente',1,0);
$pdf->SetX(140);
$pdf->Cell(0,6, 'Agência');
$pdf->SetX(160);
$pdf->Cell(0,6, 'Conta');
$pdf->SetX(180);
$pdf->Cell(0,6, 'Ativo');
