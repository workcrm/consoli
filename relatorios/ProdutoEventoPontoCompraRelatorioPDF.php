<?php
###########
## Módulo de relatório geral de produtos do evento em ponto de compra
...
$sql = mysql_query("SELECT 
					...
					AND ite.estoque_atual <= ite.estoque_minimo
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,6,'Relação Geral de Produtos em Ponto de Compra');
		$this->SetFont('Arial','',9);
