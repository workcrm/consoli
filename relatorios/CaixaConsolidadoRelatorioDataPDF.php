<?php
###########
## Módulo de relatório de eventos por caixa - CONSOLIDADO
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(0,6,"Relação de Lançamentos no Caixa - Consolidado");
...
if ($TipoLancamento == 0 OR $TipoLancamento == 2)
{
	...
	//caso for pela data do pagamento
	if ($DataProcura == 1)
	{
	...
	//caso for pela data de vencimento
	if ($DataProcura == 3)
	{
