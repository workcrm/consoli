<?php
###########
## Módulo de relatório geral de categorias de repertório
...
$sql = mysql_query("SELECT * FROM categoria_repertorio WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Momentos de Repertório');
  $this->SetFont('Arial','',9);
