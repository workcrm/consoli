<?php
###########
## Módulo de relatório de eventos por caixa - ANALITICO	SEM AGRUPAR POR CENTRO DE CUSTO
...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		if ($_GET["Regiao"] > 0)
		{
			...
			$desc_regiao = "Saídas da Regional: " . $dados_regiao["nome"];
		...
		$this->Cell(0,6,'Relação de Lançamentos no Caixa - Analítico / Sem Agrupamento');
		...
		$this->Cell(0,6, ' ',1,0,'',1);
		$this->SetX(14);
		$this->Cell(150,6, 'Conta-Caixa','TB',0,'L',1);
...
//Verifica se deve imprimir as entradas para totalizar
if ($TipoLancamento == 0 OR $TipoLancamento == 1)
{
...
//Verifica se deve imprimir as saidas
if ($TipoLancamento == 0 AND $DataProcura == 1)
{
