<?php
###########
## Módulo de relatório geral de brindes
...
$sql = mysql_query("SELECT * FROM brindes WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Brindes');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Brindes');
...
$pdf->Cell(0,6, 'Descrição do Brinde',1,0,'L',1);
$pdf->SetX(170);
$pdf->Cell(0,6, 'Ativo');
