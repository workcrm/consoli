<?php
###########
## Módulo de relatório geral de tipos de documento
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Tipos de Documento');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Tipos de Documento');
...
$pdf->Cell(0,6, 'Descrição do Tipo de Documento',1,0,'L',1);
$pdf->SetX(180);
$pdf->Cell(0,6, 'Ativo');
