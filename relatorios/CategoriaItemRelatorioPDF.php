<?php
###########
## Módulo de relatório geral de categorias de item
...
$sql = mysql_query("SELECT * FROM categoria_item WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Centro de Custo de Produtos');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Centro de Custos de Produto');
...
$pdf->Cell(0,6, 'Descrição do Centro de Custo',1,0,'L',1);
$pdf->SetX(170);
$pdf->Cell(0,6, 'Ativo');
