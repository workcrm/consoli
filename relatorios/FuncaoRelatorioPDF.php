<?php
###########
## Módulo de relatório geral de funções
...
/**
* @package workeventos
* @abstract Módulo de Relatório geral de funções
...
$sql = mysql_query("SELECT * FROM funcoes WHERE empresa_id = '$empresaId' ORDER BY nome");
...
function Header()
{
  ...
  $this->Cell(0,6,'Relação de Funções');
  $this->SetFont('Arial','',9);
...
$pdf->SetTitle('Relação de Funções');
...
$pdf->Cell(0,6, 'Descrição da Função',1,0,'L',1);
$pdf->SetX(170);
$pdf->Cell(0,6, 'Ativo');
