<?php
###########
## Módulo de relatório de freelances
...
$sql = mysql_query("SELECT
										...
										WHERE col.empresa_id = $empresaId AND col.tipo = 1
										ORDER BY col.nome");
...
function Header()
{
  ...
  $this->Cell(0,6,"Relação de Freelances");
  $this->SetFont("Arial","",9);
...
$pdf->SetTitle("Relação de Freelances");
...
$pdf->Cell(0,6, "Total de Freelances: " . $registros,"T");
