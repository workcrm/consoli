...
$sql = "SELECT 
		...
		LEFT OUTER JOIN item_evento item ON item.id = prod.produto_id
...
<form id="form" name="produtos" action="sistema.php?ModuloNome=OrdemCompraProdutoAvulsoAltera" method="post" onsubmit=""> 
	...
	<tr>
		<td class="text" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td>
						<img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Alteração de Produto da Ordem de Compra</span>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td width="100%" class="text">
						...
						if($_POST['Submit'])
						{
							...
							$sql = mysql_query("UPDATE ordem_compra_produto SET quantidade = '$edtProdutoQuantidade', valor_unitario = '$edtProdutoValor' WHERE id = '$ItemId'");
						...
						<table cellSpacing="0" cellPadding="0" width="520" border="0">
							<tr>
								<td style="padding-bottom: 2px">
									...
									<input name="ItemId" type="hidden" value="<?php echo $campos[id] ?>" />
									<input name="OrdemId" type="hidden" value="<?php echo $OrdemId ?>" />
									<input name="ProdutoId" type="hidden" value="<?php echo $ProdutoId ?>" />
									<?php
						...
						<table class="tabDetailView" cellspacing="0" cellpadding="0" width="100%" border="0" >
							...
							<tr>
								...
								<td width="620" colspan="3" valign="middle" class="tabDetailViewDF">
									<b><?php echo "(" . $campos[produto_id] . ") - " . $campos[item_nome] ?></b>
								</td>
							</tr>
							<tr>
								<td valign="top" class="dataLabel">Quantidade:</td>
								<td valign="middle" class="tabDetailViewDF">
									<input name="edtProdutoQuantidade" type="text" class="datafield" id="edtProdutoQuantidade" style="width: 80px" maxlength="8" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $campos["quantidade"] ?>" /> 
								</td>
							</tr>
							<tr>
								...
								<td valign="middle" class="tabDetailViewDF">
									<?php
										...
										$valor_alterar = str_replace(".",",",$campos["valor_unitario"]);
