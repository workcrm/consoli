<?php 
###########
## Módulo para exibição da filtragem do relatório dos cheques da empresa - pre datados
						...
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								<td class="tabDetailViewDL" style="TEXT-ALIGN: left">
									<img src="image/bt_cadastro.gif" width="16" height="15" /> Selecione a Situação desejada para filtragem dos cheques: 
								</td>
							</tr>
						</table>
					</td>
