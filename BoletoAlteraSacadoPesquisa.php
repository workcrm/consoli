...
$chavePesquisa = $_GET['Boleto'];

//Monta a query para pegar os dados
$sql = "SELECT * FROM boleto WHERE evento_id = '$chavePesquisa' ORDER BY sacado";
...
if ($registros == 0) 
{
	...
	echo "<table width='100%' align='left' border='0' cellspacing='0' cellpadding='0'>
			<tr>
				<td valign='middle'><span class='TituloModulo'>Boletos: </span><span class='style1'>Não há boletos com esse numero !</span></td>
			</tr>
		</table>";
