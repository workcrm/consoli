<?php 
###########
## Módulo para Cadastro de Categorias de Contas
...
/**
* @package workeventos
* @abstract Módulo Para cadastro de Categorias de Contas
...
function wdSubmitCategoria() {
   ...
   if (Form.edtNome.value.length == 0) {
      alert("É necessário informar a descrição da Categoria !");
      Form.edtNome.focus();
      return false;
   }
        ...
        <TBODY>
          ...
          <tr>
            ...
            <INPUT class="button" title="Limpa o conteúdo dos campos digitados [Alt+L]" accessKey='L' name='Reset' type='reset' id='Reset' value='Limpar Campos'>
             ...
             <TD align="right">
						 		<input class="button" title="Emite o relatório das Categorias de Conta cadastradas" name='btnRelatorio' type='button' id='btnRelatorio' value='Emitir Relatório' style="width:100px" onclick="abreJanela('./relatorios/CategoriaContaRelatorioPDF.php?UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaId=<?php echo $empresaId ?>&EmpresaNome=<?php echo $empresaNome ?>')" />
			    </TD>
	       </TR>
         </TBODY>
         </TABLE>
...
<table width="750" id="4" cellpadding="0" cellspacing="0" border="0" class="listView">
	  ...
	  <tr height="20">
        <td width='42' class="listViewThS1">
          ...
          &nbsp;&nbsp;Descrição da Categoria de Conta
        </td>
	...
	<?php
      ...
      //Efetua o switch para exibir o valor do tipo
  	  switch ($dados[tipo]) {
       	case 1: $letra_tipo = "Débito";	break;
			  case 2: $letra_tipo = "Crédito";	break;       	
  	  }
	...
	?>
	  ...
	  <tr height='16'>
        <td width='42'>
		  	  <div align="center">
            <img src="image/grid_exclui.gif" alt="Excluir Registro" width="12" height="12" border="0" onClick="if(confirm('Confirma a exclusão do registro ?\nA exclusão de registros desta tabela não é recomendada.\nRecomendamos a utilização da caixa [Cadastro Ativo] caso desejar desativar um registro.')) {wdCarregarFormulario('ProcessaExclusaoGet.php?Id=<?php echo $dados[id] ?>&Modulo=categoria_conta&Retorno=CategoriaContaCadastra','conteudo')}" style="cursor: pointer"></a>
