<?php 
###########
## Módulo para alteraçao de Grupos de Conta
  ...
  <tr>
    <td class="text" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
			  <tr>
			    <td width="440"><img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Alteração de Centro de Custo de Contas </span></td>
			  </tr>
			  <tr>
			    <td colspan="5">
        ...
        <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
          ...
          <tr>
            ...
            <INPUT class=button title="Cancela as alterações efetuadas no registro" name="Reset" type="reset" id="Reset" value="Cancela Alterações">
             ...
             <TD align="right">
							 <input class="button" title="Retorna ao formulário de cadastro" name="btnVoltar" type="button" id="btnVoltar" value="Voltar" style="width:70px" onclick="window.location='sistema.php?ModuloNome=GrupoContaCadastra';" />						 
						 </TD>
	       </TR>
         </TBODY>
         </TABLE>
