...
$Server_atu = 'mysql15.kinghost.net';
...
$conexao = @mysql_connect($Server_atu,$Login_atu,$Senha_atu) or die('KING: Nao foi possivel se conectar com o banco de dados do servidor de destino !');
