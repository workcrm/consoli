<?php 
###########
## Módulo para cadastro de serviços de evento
	...
	<tr>
		<td class="text" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td>
						<img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Cadastramento de Serviços do Evento</span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td class='text'>
						...
						<?php
							...
							if($_POST['Submit'])
							{
								...
								//Primeiro apaga todos os servicos que já existem na base
								...
								echo "<div id='99'><table width='100%' border='0' align='left' cellpadding='0' cellspacing='0' class='text'><tr><td height='22' width='20' valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; padding-top: 1px; border-right: 0px'><img src='./image/bt_informacao.gif' border='0' /></td><td valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; border-left: 0px'><strong>Serviços cadastrados com sucesso !</strong></td></tr><tr><td>&nbsp</td></tr></table></td></tr><tr><td></div>";
          ...
          <table cellspacing="0" cellpadding="0" border="0">
	          ...
	          <tr>
		        	<td style="PADDING-BOTTOM: 2px">
		        		<input name="Submit" type="submit" class="button" title="Salva os Serviços do Evento" value="Salvar Serviços do Evento" />
	  			 ...
	  			 <tr>
	    			 <td colspan="15" align="right">
	      			 <table border="0" cellpadding="0" cellspacing="0" width="100%">
	        			 <tr>
	          			 <td width="300" align="left" class="listViewPaginationTdS1" style="PADDING-BOTTOM: 2px"><span class="pageNumbers"><b>Selecione os serviços a incluir no evento</b></span></td>
	          			 <td align="right" class="listViewPaginationTdS1" style="PADDING-BOTTOM: 2px"><span class="pageNumbers" style="color: #990000"><b>A quantidade de cada serviço é UNITÁRIA de acordo com sua respectiva unidade de medida.&nbsp;</b></span></td>
	        			 </tr>
	      			 </table>
	    			 </td>
	  			 </tr>
        		   ...
        		   <div align="center">Inc.</div>
    				 ...
    				 <td colspan="7" valign="bottom" style="padding-left: 8px">    				 	 
						   ...
						   while ($dados_servico = mysql_fetch_array($lista_servico))
						   {
								...
								//Caso encontrou o serviço para ser incluso no orçamento
								if ($conta_retorno == 1) 
								{
							...
							<tr height="16">
								<td valign="top" style="border-bottom: 1px dotted;">
									<div align="center">
										<input name="<?php echo ++$edtServicoChk ?>" type="checkbox" value="<?php echo $dados_servico[id] ?>" style="border: 0px" title="Clique para marcar ou desmarcar a inclusão deste serviço no evento" onclick="if (this.checked == true){document.cadastro.edtQtde<?php echo $edtServicoChk ?>.disabled = false; document.cadastro.edtQtde<?php echo $edtServicoChk ?>.style.backgroundColor = '#FFFFFF'; document.cadastro.chkCulto<?php echo $edtServicoChk ?>.checked = true; document.cadastro.chkColacao<?php echo $edtServicoChk ?>.checked = true; document.cadastro.chkJantar<?php echo $edtServicoChk ?>.checked = true; document.cadastro.chkBaile<?php echo $edtServicoChk ?>.checked = true;} else {document.cadastro.edtQtde<?php echo $edtServicoChk ?>.disabled = true; document.cadastro.edtQtde<?php echo $edtServicoChk ?>.style.backgroundColor = '#E6E6E6'; document.cadastro.chkCulto<?php echo $edtServicoChk ?>.checked = false; document.cadastro.chkColacao<?php echo $edtServicoChk ?>.checked = false; document.cadastro.chkJantar<?php echo $edtServicoChk ?>.checked = false; document.cadastro.chkBaile<?php echo $edtServicoChk ?>.checked = false;}" <?php echo $chkServico ?>/>
									</div>
								</td>
								<td valign="top" bgcolor="#fdfdfd" class="currentTabList" style="padding-top: 2px; border-bottom: 1px dotted;">
									<input name="edtQtde<?php echo $edtServicoChk ?>" <?php echo $QtdeRead ?> type="text" class="datafield" style="background-color: <?php echo $QtdeCor ?>; width: 35px" maxlength="10" title="Informe a quantidade do serviço" value="<?php echo $dados_procura_servico[quantidade] ?>" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
								</td>
								<td valign="top" bgcolor="#fdfdfd" class="oddListRowS1" style="border-bottom: 1px dotted;">
									...
									<input name="chkCulto<?php echo $edtServicoChk ?>" id="chkCulto<?php echo $edtServicoChk ?>" type="checkbox" value="1" style="border: 0px" <?php echo $marca_culto  ?> ><span style="font-size: 11px">Culto</span>&nbsp;&nbsp;&nbsp;&nbsp;<input name="chkColacao<?php echo $edtServicoChk ?>" id="chkColacao<?php echo $edtServicoChk ?>" type="checkbox"  value="1" style="border: 0px" <?php echo $marca_colacao  ?> ><span style="font-size: 11px">Colação</span>&nbsp;&nbsp;&nbsp;&nbsp;<input name="chkJantar<?php echo $edtServicoChk ?>" id="chkJantar<?php echo $edtServicoChk ?>" type="checkbox" value="1" style="border: 0px" <?php echo $marca_jantar  ?> ><span style="font-size: 11px">Jantar<span>&nbsp;&nbsp;&nbsp;&nbsp;<input name="chkBaile<?php echo $edtServicoChk ?>" id="chkBaile<?php echo $edtServicoChk ?>" type="checkbox" value="1" style="border: 0px" <?php echo $marca_baile ?> ><span style="font-size: 11px">Baile</span>
								</td>
								<td valign="top" bgcolor="#fdfdfd" class="currentTabList" style="padding-top: 2px; border-bottom: 1px dotted;">
									<?php							
									
										//Verifica se já existe um preço de venda cadastrado para o serviço
										...
										
										{
											...
											//Caso não, pega o valor de venda padrão do serviço no cadastro normal
