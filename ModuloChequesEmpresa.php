<?php
###########
## Módulo para Cheques da Empresa
...
function wdCarregarFiltragem() 
{
	...
	{
		wdCarregarFormulario('ChequeEmpresaRelatorioSituacao.php?headers=1','filtragem','1');
	}
	
	if (edtAgruparValor == 2) 
	{
		wdCarregarFormulario('ChequeEmpresaRelatorioPre.php?headers=1','filtragem','1');
	}
	
	if (edtAgruparValor == 3) 
	{
		wdCarregarFormulario('ChequeEmpresaRelatorioContaCorrente.php?headers=1','filtragem','1');
	}
	
	if (edtAgruparValor == 4) 
	{
		wdCarregarFormulario('ChequeEmpresaRelatorioEvento.php?headers=1','filtragem','1');
	}		
	
	if (edtAgruparValor == 5) 
	{
		wdCarregarFormulario('ChequeEmpresaRelatorioEventoFormando.php?headers=1','filtragem','1');
	}
...
function wdVisualizarRelatorio() 
{
	...
	if (edtAgruparValor == 1) 
	{
		...
		var urlCarrega = 'ChequeEmpresaLista.php?TipoListagem=1&TipoSituacao='+ edtSituacaoValor  + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	...
	if (edtAgruparValor == 2) 
	{
		...
		//Monta a url a acessar	 
		var urlCarrega = 'ChequeEmpresaLista.php?TipoListagem=2&TipoSituacao='+ edtSituacaoValor  + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	...
	if (edtAgruparValor == 3) 
	{
		...
		//Monta a url a acessar	 
		var urlCarrega = 'ChequeEmpresaLista.php?TipoListagem=3&TipoSituacao='+ edtSituacaoValor  + '&BancoId=' + Form.cmbBancoId.value + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	...
	if (edtAgruparValor == 4) 
	{
		...
		//Monta a url a acessar	 
		var urlCarrega = 'ChequeEmpresaLista.php?TipoListagem=4&TipoSituacao='+ edtSituacaoValor + '&EventoId=' + Form.cmbEventoId.value + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
...
function wdCarregarRelatorio() 
{
	...
	if (edtAgruparValor == 1) 
	{
		...
		var urlRelatorio = './relatorios/ChequeEmpresaRelatorioPDF.php?EmpresaId=<?php echo $empresaId ?>&UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaNome=<?php echo $empresaNome ?>&TipoListagem=1&TipoSituacao='+ edtSituacaoValor  + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	}
	
	
	//Caso for por bom para
	if (edtAgruparValor == 2) 
	{
		...
		//Monta a url do relatório		
		var urlRelatorio = './relatorios/ChequeEmpresaRelatorioPDF.php?EmpresaId=<?php echo $empresaId ?>&UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaNome=<?php echo $empresaNome ?>&TipoListagem=2&TipoSituacao='+ edtSituacaoValor  + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	}
	...
	if (edtAgruparValor == 3) 
	{
		...
		//Monta a url do relatório		
		var urlRelatorio = './relatorios/ChequeEmpresaRelatorioPDF.php?EmpresaId=<?php echo $empresaId ?>&UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaNome=<?php echo $empresaNome ?>&TipoListagem=3&TipoSituacao='+ edtSituacaoValor + '&BancoId=' + Form.cmbBancoId.value + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	}
	...
	if (edtAgruparValor == 4) 
	{
		...
		//Monta a url do relatório		
		var urlRelatorio = './relatorios/ChequeEmpresaRelatorioPDF.php?EmpresaId=<?php echo $empresaId ?>&UsuarioNome=<?php echo $usuarioNome . " " . $usuarioSobrenome ?>&EmpresaNome=<?php echo $empresaNome ?>&TipoListagem=4&TipoSituacao='+ edtSituacaoValor + '&EventoId=' + Form.cmbEventoId.value + '&DataIni='+ Form.edtDataIni.value + '&DataFim=' + Form.edtDataFim.value;
	}
	...
	<tr>
		<td valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td width="750">
						<img src="image/lat_cadastro.gif"/>&nbsp;<span class="TituloModulo">Consulta Cheques da Empresa</span>			  	
					</td>
				</tr>
				<tr>
					<td colspan="5">
				...
				<tr>
					<td width='440'>
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							...
							<tr valign="middle" style="padding: 1px">
								<td height="20">
									<input type="radio" name="edtAgrupar" value="3" onclick="wdCarregarFiltragem()" /> Cheques por Conta Corrente
								</td>
							</tr>
							<tr valign="middle" style="padding: 1px">
								<td height="20">
	...
	<tr>
		<td>
			<div id="filtragem">
				...
				include "ChequeEmpresaRelatorioSituacao.php";
				?>
			</div>
		</td>
	</tr>
