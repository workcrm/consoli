<?php
###########
## Módulo de pesquisa para CLIENTES
...
if ($registros_conta == 0) 
{
	...
	<table width='750' align='left' border='0' cellspacing='0' cellpadding='0'>
		<tr>
      <td valign='middle'><span class='TituloModulo'>Clientes: </span><span class='style1'>Não há ocorrências que satisfaçam os critérios de pesquisa</span></td>
    </tr>";
} 
...

{
	...
	echo "
		<table width='100%' align='left' border='0' cellspacing='0' cellpadding='0'>
			<tr>
				<td valign='middle'>
					<span class='TituloModulo'>Clientes: </span><span class='style1'>A pesquisa retornou $registros_conta resultado(s)</br>
				</td>
			</tr>
			<tr>
				<td>		  
	...
	{		
		...
		<tr height="16">	
			...
			<td valign="middle" bgcolor="#fdfdfd" class="oddListRowS1">
				<a title="Clique para exibir os detalhes deste cliente" href="#" onclick="wdCarregarFormulario('ClienteExibe.php?ClienteId=<?php echo $dados_conta[id] ?>','conteudo')"><?php echo $dados_conta[nome] ?></a>
			</td>
