<?php 
###########
## Módulo para exibição da filtragem do relatório dos cheques - por banco
...
//Monta o SQL
$lista_banco = "SELECT * FROM bancos WHERE empresa_id = 1 AND ativo = '1' ORDER BY nome";
...
<br />
<span class="TituloModulo"> Filtragem: <font color="#990000">Por Banco</font><br />
</span>
		...
		<td valign="middle"> 
			<table class="tabDetailView" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
			  	...
			  	<tr>
					<td class="dataLabel" width="120">Banco:</td>
