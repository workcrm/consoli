<?php 
###########
## Módulo para alteraçao de Locais do Evento
...
function wdSubmitLocalEventoAltera() {
	 var Form;
   Form = document.frmLocalEventoAltera;
...
<form name="frmLocalEventoAltera" action="sistema.php?ModuloNome=LocalEventoAltera" method="post" onsubmit="return wdSubmitLocalEventoAltera()">
  ...
  <tr>
    <td class="text" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
			  <tr>
			    <td width="440"><img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Alteração de Tipo de Local de Evento </span></td>
			  </tr>
			  <tr>
			    <td colspan="5">
        ...
        <tr>
          ...
          <?php
	          ...
	          if($_POST["Alterar"]) {
    	    		...
    	    		$sql = mysql_query("
               									UPDATE local_evento SET 
																ativo = '$chkAtivo',
																nome = '$edtNome'
																WHERE id = '$id' ");			 
							
							//Exibe a mensagem de inclusão com sucesso
        			echo "<div id='99'><table width='100%' border='0' align='left' cellpadding='0' cellspacing='0' class='text'><tr><td height='22' width='20' valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; padding-top: 1px; border-right: 0px'><img src='./image/bt_informacao.gif' border='0' /></td><td valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; border-left: 0px'><strong>Tipo de Local alterado com sucesso !</strong></td></tr><tr><td>&nbsp</td></tr></table></td></tr><tr><td></div><script language='javascript'>setTimeout('oculta(99)', 2500)</script>";
            }

		//Recebe os valores passados do form anterior para edição do registro
		if($_POST) {
		  $LocalEventoId = $_POST["Id"]; 
		} else {
		  $LocalEventoId = $_GET["Id"]; 
		}
		//Monta o sql
    $sql = "SELECT * FROM local_evento WHERE id = $LocalEventoId";
		//Executa a query
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
           <tr>
	        	 <td style="PADDING-BOTTOM: 2px">
	        		 <input name="Id" type="hidden" value="<?php echo $LocalEventoId ?>" />
             ...
             <td align="right">
							 <input class="button" title="Retorna ao formulário de cadastro" name="btnVoltar" type="button" id="btnVoltar" value="Voltar" style="width:70px" onclick="window.location='sistema.php?ModuloNome=LocalEventoCadastra';" />						 
						 </td>
	       	 </tr>
         </table>
