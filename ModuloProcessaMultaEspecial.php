<?php 
###########
## Módulo para Processamento de Multa e Juros de boletos formato epecial
...
$data_ignora = DataMySQLInserir($_GET['DataIgnora']);
$data_processa = $dados_multa['data_atualizacao_multa'];

echo '<br/>Ultima Atualizacao: ' . $data_processa;
echo '<br/>Data Ignorar: ' . $data_ignora;
...
$consulta_multa = "SELECT
                  ...
                  AND data_vencimento != '$data_ignora'
                  AND situacao = 1
