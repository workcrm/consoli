<?php 
###########
## Módulo para exibição da filtragem do relatório das contas a receber - por centro de csto
## Criado: 30/07/2010 - Maycon Edinger
## Alterado: 
## Alterações: 
###########
            ...
            <td class="listViewPaginationTdS1" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px" colspan="21">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
	  			...
	  			<tr>
					...
					<tr>
            <td class="dataLabel" width="105">In&iacute;cio:</td>
