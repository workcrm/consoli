<?php 
###########
## Módulo para alteraçao dos brindes
...
function wdSubmitTipoAltera() {
   ...
   if (Form.edtNome.value.length == 0) {
      alert("É necessário informar a descrição do brinde !");
      Form.edtNome.focus();
      return false;
   }
...
<form name="frmTipoAltera" action="sistema.php?ModuloNome=BrindeAltera" method="post" onsubmit="return wdSubmitTipoAltera()">
  ...
  <tr>
    <td class="text" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
			  <tr>
			    <td width="440"><img src="image/lat_cadastro.gif" />&nbsp;<span class="TituloModulo">Alteração de Brinde</span></td>
			  </tr>
			  <tr>
			    <td colspan="5">
      ...
      <table id="2" width="100%" align="left" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <?php
	          ...
	          if($_POST["Alterar"]) {
        			...
        			echo "<div id='99'><table width='100%' border='0' align='left' cellpadding='0' cellspacing='0' class='text'><tr><td height='22' width='20' valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; padding-top: 1px; border-right: 0px'><img src='./image/bt_informacao.gif' border='0' /></td><td valign='middle' bgcolor='#FFFFCD' style='border: solid 1px; padding-left: 4px; border-left: 0px'><strong>Brinde alterado com sucesso !</strong></td></tr><tr><td>&nbsp</td></tr></table></td></tr><tr><td></div><script language='javascript'>setTimeout('oculta(99)', 2500)</script>";
            }
		...
		//Monta o sql
    $sql = "SELECT * FROM brindes WHERE id = $TipoColaboradorId";
		//Executa a query
    ...
    $campos = mysql_fetch_array($resultado);
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
          <tr>
            ...
            <td align="right">
							 <input class="button" title="Retorna ao formulário de cadastro" name="btnVoltar" type="button" id="btnVoltar" value="Voltar" style="width:70px" onclick="window.location='sistema.php?ModuloNome=BrindeCadastra';" />						 
						</td>
	       	</tr>
        </table>
