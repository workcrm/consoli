<?php 
###########
## Módulo para busca de formando de um evento para utilização no pedido do foto e vídeo
...
<select name="cmbFormandoId" id="cmbFormandoId" style="width:400px" onchange="busca_produtos()">
