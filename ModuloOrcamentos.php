<?php
###########
## Módulo para Pesquisa de Orçamentos
...
if (Form.edtDataIni.value == 0) {
   ...
   var edtClassificarValor = document.getElementsByName('edtClassificar');   
	...
	urlPesquisa = "ModuloOrcamentosLista.php?edtPesquisa=" + Form.edtPesquisa.value + "&edtOrdenar=" + edtOrdenarValor + "&edtClassificar=" + edtClassificarValor + "&edtDataIni=" + Form.edtDataIni.value + "&edtDataFim=" + Form.edtDataFim.value;
...
function EfetuaPesquisa(Letra) {
  ...
  Form = document.frmContasPesquisa;
   ...
   var edtClassificarValor = document.getElementsByName('edtClassificar');   
	...
	urlPesquisa = "ModuloOrcamentosLista.php?ChaveFiltragem=" + Letra + "&edtOrdenar=" + edtOrdenarValor + "&edtClassificar=" + edtClassificarValor + "&edtDataIni=" + Form.edtDataIni.value + "&edtDataFim=" + Form.edtDataFim.value;
  ...
  <tr>
    <td valign="top">
		  <table width="100%" cellpadding="0" cellspacing="0" border="0">
		    <tr>
		      <td width="440">
			    <img src="image/lat_cadastro.gif"/>&nbsp;<span class="TituloModulo">Pesquisar Orçamentos</span>
			  	</td>
		    </tr>
		    <tr>
		      <td colspan="5">
              ...
              <tr>
                <td class="listViewPaginationTdS1" style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-WEIGHT: normal; PADDING-BOTTOM: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px" colspan="20">
                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                      <tr>
                        <td class="tabDetailViewDL" style="TEXT-ALIGN: left"><img src="image/bt_pesquisar.gif"> Informe o nome do Evento em orçamento a pesquisar e clique em [Pesquisar Eventos em Orçamento] </td>
                      </tr>
                  </table>
                </td>
              </tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr valign="middle">
                      ...
                      <td><span style="PADDING-BOTTOM: 2px">
                        <input class="button" title="Inicia a pesquisa do(s) eventos(s) com base nos valores informados" name="btnPesquisa" type="button" id="btnPesquisa" value="Pesquisar Eventos em Orçamento" onclick="EfetuaConsulta()"></span></td>
                    </tr>
                  </table>
                </td>
              </tr>
